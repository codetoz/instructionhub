      ...
      {tabValue === 0 && (
        <Box sx={{ mt: 2 }}>
          <Typography variant='body1'>
            Here you can manage all of your instructions. Create, edit, or remove instructions as needed.
          </Typography>
          <Box
            sx={{
              backgroundColor: '#333',
          ...
          >
            ...
            <Button variant='contained'>Add Instructions</Button>
          </Box>
        </Box>
      )}
      {tabValue === 1 && (
        <Box sx={{ mt: 2 }}>
          <Typography variant='body1'>
            Manage all of your groups here. You can create new groups or update existing ones.
          </Typography>
          <Box
            sx={{
              backgroundColor: '#333',
